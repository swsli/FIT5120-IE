...
('Amphibians', 'Eungella dayfrog', 'The Eungella dayfrog is a small, 25 to 28 mm long frog with dark brown markings.', 'Seaweed.', 'Over-collecting, Drought, Floods, Diseases', 'Monitor populations, Look into disease impacts, Inform the public of recovery actions'),
('Amphibians', 'Fleay\'s barred frog', 'Fleay\'s barred frog is a large frog, growing to 90 mm in length, with a light to dark brown back.', 'Montane rainforest.', 'Eaten by feral animals, Wood cutting, Diseases, Urban development', 'Manage the recovery, Monitor populations, Protect forests'),
('Amphibians', 'Giant barred frog', 'The giant barred frog is an olive-green and black frog, with dark spots on its back, that grows up to 115 mm in length.', 'Rainforests and wet forests.', 'Water pollution, Harm caused by feral animals, Plants growing in its habitat', 'Monitor populations, Look into disease impacts, Inform the public of recovery actions'),
('Amphibians', 'Northern tinkerfrog', 'The northern tinkerfrog is a small, 30 mm long, gray and brown frog.', 'Rocky streams in rainforests.', 'Drought, Floods, Heavy metal pollution', 'Monitor populations, Look into disease impacts, Inform the public of recovery actions'),
('Amphibians', 'Waterfall frog', 'The waterfall frog is an olive green frog with spots, with its size ranging from 40 to 53 mm in length.', 'Alongside water and waterfalls.', 'Diseases, Harm caused by feral pigs', 'Monitor populations, Look into disease impacts, Inform the public of recovery actions'),
('Birds', 'Black-throated finch (white-rumped subspecies)', 'The black-throated finch is a small bird with a black throat, blue-gray head, and white back.', 'Woodlands, like eucalyptus trees.', 'Overlogging of woodlands, Overgrazing, Fire on bushland, Illegal trading', 'Protect its habitat, Inform farmers of these threats'),
...
('Birds', 'Crimson finch (white-bellied subspecies)', 'The crimson finch is a small, 13 cm tall bird with a white belly.', 'Grass near fresh water.', 'Fire, Weeds taking over its habitat, Grazing', 'Manage fire regimes, Control grazing, Monitor weeds'),
('Birds', 'Eastern bristlebird', 'The eastern bristlebird is a small, 20 cm tall ground bird with its tail making up half of its size.', 'Open forests and grasses.', 'Fire, Over-grazing, Human hunting', 'Emergency evacuation when fires break out, Monitor hunting, Monitor grazing'),
('Birds', 'Golden-shouldered parrot', 'The golden-shouldered parrot is a 24 to 26 cm tall bird with a brown back and golden shoulders.', 'Woodlands and grasses.', 'Eaten by feral cats, Hunted by bigger birds, Fires, Lack of food', 'Fire management, Monitor populations'),
...
('Birds', 'Night parrot', 'The night parrot is a small, short-tailed parrot.', 'Dry grasses.', 'Fires, Hunting by feral mammals', 'Protect its habitat, Manage recovery'),
...
('Birds', 'Star finch (eastern subspecies)', 'The star finch is a small, 11 to 12 cm tall finch with a red face.', 'Grasslands and woodlands near fresh water.', 'Habitat destruction, Over-grazing, Illegal trading', 'Protect its habitat, Prohibit illegal trading'),
('Fish', 'Elizabeth Springs goby', 'The Elizabeth Springs goby is a freshwater fish that grows to 6.2 cm in length.', 'Elizabeth Springs (a low freshwater spring).', 'Difficult to find wild spawning sites', 'Monitor populations'),
('Fish', 'Redfin blue eye', 'The redfin blue eye is Australia\'s smallest freshwater fish, growing up to only 30 mm in length.', 'Springs and other warm water.', 'Water pollution, Habitat damage caused by feral animals, Over-harvesting', 'Protect its habitat, Monitor water flows'),
('Insects', 'Australian fritillary butterfly', 'The Australian fritillary butterfly is a 60 mm large butterfly, with a pale orange-brown upperside and forewing, and a pinkish-orange underside.', 'Open swampy coasts.', 'Farming, Urbanisation', 'Track populations, Protect its habitat'),
...
('Snails', 'Antbed parrot moth', 'The antbed parrot moth is an adult moth which has brown forewings growing up to 2.5 cm in length.', 'Lives in golden shoudered parrots\' nests.', 'Climate change, Habitat damage', 'Protect its habitat, Monitor populations'),
...
('Fish', 'Lake Eacham rainbowfish', 'The Lake Eacham rainbowfish is a 6.5 cm long rainbow fish with silvery sides and a brown back.', 'Rainforest rivers and crater lakes.', 'Invasive species', 'Protect its habitat, Protect water quality'),
('Fish', 'Mary River cod', 'The Mary River cod is a large, 70 cm long fish with golden-yellow to brown scales and black spots.', 'Lakes and dams.', 'Over-fishing, Habitat damage', 'Release these cods if caught while fishing, Protect water quality'),
('Fish', 'Oxleyan pygmy perch', 'The Oxleyan pygmy perch is a small, 3.5 cm long fish with light brown to olive colouring and some dark brown bars.', 'Freshwater lakes.', 'Habitat loss, Illegal fishing', 'Protect and restore essential habitat, Reduce instances of illegal fishing, Minimise the impacts of introduced fish'),
...
('Reptiles', 'Gulf snapping turtle', 'The gulf snapping turtle is a medium- to large-sized, short-necked, brown to black coloured turtle that grows up to 40 cm in length.', 'Deep water pools.', 'Harm caused by feral pigs, Fire, Hunting, Climate change', 'Control feral pigs, Protect its habitat, Limit hunting'),
