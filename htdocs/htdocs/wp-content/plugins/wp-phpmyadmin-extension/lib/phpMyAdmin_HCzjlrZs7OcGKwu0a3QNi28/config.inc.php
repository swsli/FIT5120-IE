...
$cfg['blowfish_secret']					= '--}O\\\'Rg&n:G+IF_g@1$;/^>hS}+_]q@' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_HCzjlrZs7OcGKwu0a3QNi28/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
