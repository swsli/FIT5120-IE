...
class PAFE_Gradient_Button extends \Elementor\Widget_Base {
	...
	protected function init_control() {
		add_action( 'elementor/element/button/section_style/after_section_end', [ $this, 'register_controls' ], 10, 2 );
		add_action( 'elementor/element/form/section_button_style/after_section_end', [ $this, 'register_controls' ], 10, 2 );
	}
