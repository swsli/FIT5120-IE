...
if ( ! function_exists( 'arenabiz_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function arenabiz_posted_on() {
		...
		if ( is_singular() && ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
			...
			comments_popup_link( esc_html__( '0 Comments', 'arenabiz' ) );
			echo '</span>';
		}
	}
endif;

if ( ! function_exists( 'arenabiz_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function arenabiz_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'arenabiz' ),
			'<span class="author vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>'
		);
...
if ( ! function_exists( 'arenabiz_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function arenabiz_entry_footer() {
		// Hide category and tag text for pages.
		if ( 'post' === get_post_type() ) {
			/* translators: used between list items, there is a space after the comma */
			$categories_list = get_the_category_list( esc_html__( ', ', 'arenabiz' ) );
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'arenabiz' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'arenabiz' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'arenabiz_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function arenabiz_post_thumbnail() {
