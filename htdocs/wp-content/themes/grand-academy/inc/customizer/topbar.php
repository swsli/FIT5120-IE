...
$wp_customize->add_panel( 'header_top_panel', array(
    'title'          => __( 'Header Top', 'grand-academy' ),
    'priority'       => 20,
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Contact Info', 'grand-academy' ),
...
$wp_customize->add_control(
    'theme_options[show_header_contact_info]',
    array(
        'label'       => __( 'Show Contact Info', 'grand-academy' ),
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Location', 'grand-academy' ),
        'description'     => __( 'Enter Location.', 'grand-academy' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'grand_academy_contact_info_ac',
    )
);

/** Phone */
$wp_customize->add_setting( 'theme_options[header_phone]', array(
    'sanitize_callback' => 'grand_academy_sanitize_phone_number',
) );

$wp_customize->add_control(
    'theme_options[header_phone]',
    array(
        'label'           => __( 'Phone', 'grand-academy' ),
        'description'     => __( 'Enter phone number.', 'grand-academy' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'grand_academy_contact_info_ac',
    )
);
...
$wp_customize->add_control(
    'theme_options[header_email]',
    array(
        'label'           => __( 'Email', 'grand-academy' ),
        'description'     => __( 'Enter valid email address.', 'grand-academy' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'grand_academy_contact_info_ac',
    )
);
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Social Links', 'grand-academy' ),
        'panel'    => 'header_top_panel',
        'priority' => 20,
    )
);
...
$wp_customize->add_control(
    'theme_options[show_header_social_links]',
    array(
        'label'       => __( 'Show Social Links', 'grand-academy' ),
...
$wp_customize->add_control(
    'theme_options[social_link_1]',
    array(
        'label'           => __( 'Social Link 1', 'grand-academy' ),
        'description'     => __( 'Enter valid url.', 'grand-academy' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'grand_academy_social_links_active',
    )
);
...
$wp_customize->add_control(
    'theme_options[social_link_2]',
    array(
        'label'           => __( 'Social Link 2', 'grand-academy' ),
        'description'     => __( 'Enter valid url.', 'grand-academy' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'grand_academy_social_links_active',
...
$wp_customize->add_control(
    'theme_options[social_link_3]',
    array(
        'label'           => __( 'Social Link 3', 'grand-academy' ),
        'description'     => __( 'Enter valid url.', 'grand-academy' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'grand_academy_social_links_active',
