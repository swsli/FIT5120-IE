...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'grand-academy' ),
	'priority'   => 100,
...
'title'       => __('Layout Option', 'grand-academy'),
...
$wp_customize->add_control(new grand_academy_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'grand-academy'),
...
$wp_customize->add_control(new grand_academy_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'grand-academy'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new grand_academy_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'grand-academy'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new grand_academy_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'grand-academy'),
	'section' 	=> 'section_general',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'grand-academy'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => __( 'Excerpt Length', 'grand-academy' ),
	'description' => __( 'in words', 'grand-academy' ),
...
$wp_customize->add_section('section_read_more', 
	array(    
	'title'       => __('Read More Text', 'grand-academy'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Read More Text', 'grand-academy' ),
...
$wp_customize->add_section('section_blog_title', 
	array(    
	'title'       => __('Blog Title', 'grand-academy'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[your_latest_posts_title]',
	array(
	'label'    => __( 'Blog Title', 'grand-academy' ),
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'grand-academy'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'grand-academy' ),
...
$wp_customize->add_control( 'theme_options[enable_frontpage_content]', array(
	'label'       	=> __( 'Enable Content', 'grand-academy' ),
	'description' 	=> __( 'Click to enable content on static front page only.', 'grand-academy' ),
