...
Kirki::add_field( 'bizberg', array(
	...
	'output'    => array(
		...
		array(
			'element'  => 'body.bizberg_transparent_header header .navbar-default .navbar-nav > li > a:hover,body.bizberg_transparent_header .navbar-nav > li:hover,body.bizberg_transparent_header .header-search .search-form input#searchsubmit,body.bizberg_transparent_header .header-search .search-form input#searchsubmit:visited',
			'property' => 'background',
			'suffix'   => ' !important',
		),
		array(
		...
		array(
            'element'  => 'body.bizberg_transparent_header header .navbar-default .navbar-nav > li > a:hover',
