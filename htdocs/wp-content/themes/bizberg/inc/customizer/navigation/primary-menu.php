...
Kirki::add_field( 'bizberg', array(
	...
	'output'    => array(
		array(
			'element'  => '.navbar-default .navbar-nav>li>a,.header-search i,.navbar.sticky.navbar-default .navbar-nav>li>a,.navbar.sticky .header-search i',
			'property'      => 'color',
			'value_pattern' => '$'
		)
	)
...
Kirki::add_field( 'bizberg', array(
	...
	'label'       => esc_html__( 'Site Title Color ( Sticky Menu )', 'bizberg' ),
	'section'     => 'header',
	'default'     => '#333',
	'choices'     => [
		'alpha' => true,
...
Kirki::add_field( 'bizberg', array(
	...
	'label'       => esc_html__( 'Site Tagline Color ( Sticky Menu )', 'bizberg' ),
	'section'     => 'header',
	'default'     => '#333',
	'choices'     => [
		'alpha' => true,
