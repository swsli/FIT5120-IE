<div class="m-6 mt-10 bg-white shadow sm:rounded-lg">
  <div class="px-4 py-5 sm:p-6">
    ...
    <div class="mt-2 max-w-xl text-sm leading-5 text-gray-dark">
      <p>
        <?php printf(__('It looks like you are using %s. Whilst MetaSlider does support %s on the frontend of the website where users see your slideshows, some of the tools we provide back here require a modern browser.', 'ml-slider'), '<strong>' . __('Microsoft Internet Explorer 11', 'ml-slider') . '</strong>', __('IE11', 'ml-slider')); ?>
      </p>
    </div>
