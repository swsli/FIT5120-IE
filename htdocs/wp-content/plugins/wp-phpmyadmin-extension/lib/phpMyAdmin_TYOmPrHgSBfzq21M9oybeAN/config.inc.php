...
$cfg['blowfish_secret']					= '3%|hx(mRC7`km{:L./T8XN/W.dg[7rrE' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= 'https://www.blazingforest.tk/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_TYOmPrHgSBfzq21M9oybeAN/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
